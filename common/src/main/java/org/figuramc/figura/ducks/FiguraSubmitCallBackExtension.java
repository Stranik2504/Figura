...
public interface FiguraSubmitCallBackExtension {
    void figura$addPreRenderingCallback(BiFunction<VertexConsumer, PoseStack, Boolean> callback);

    default List<BiFunction<VertexConsumer, PoseStack, Boolean>> figura$getPreRenderingCallbacks() {
        return List.of();
    }
